return {
  ...
  keys = {
    ...
    { '<C-A-h>', function() require('smart-splits').resize_left() end, desc = 'Resize window left' },
    { '<C-A-j>', function() require('smart-splits').resize_down() end, desc = 'Resize window down' },
    { '<C-A-k>', function() require('smart-splits').resize_up() end, desc = 'Resize window up' },
    { '<C-A-l>', function() require('smart-splits').resize_right() end, desc = 'Resize window right' },
  },
}
